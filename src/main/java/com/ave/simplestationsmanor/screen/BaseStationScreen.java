...
import com.ave.simplestationsmanor.uihelpers.NumToString;
...
public abstract class BaseStationScreen extends AbstractContainerScreen<BaseStationMenu> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(SimpleStationsManor.MODID,
    ...
    public void render(GuiGraphics gfx, int mouseX, int mouseY, float partialTicks) {
        ...
        if (UIBlocks.FERTI_BAR.isHovered(mouseX - startX, mouseY - startY)) {
            ...
            List<Component> fertText = Arrays.asList(
                    Component.translatable("screen.simplestationsmanor.fertilizer"),
        ...
        if (UIBlocks.POWER_BAR.isHovered(mouseX - startX, mouseY - startY)) {
            ...
            List<Component> powerText = Arrays.asList(
                    Component.translatable("screen.simplestationsmanor.power"),
        ...
        if (station.type == null && UIBlocks.FILTER_SLOT.isHovered(mouseX - startX, mouseY - startY)) {
            gfx.renderTooltip(font, Component.translatable("screen.simplestationsmanor.filter"), mouseX, mouseY);
        }
    }
    ...
    protected Component getFluidName() {
        return Component.translatable("screen.simplestationsmanor.water");
    }
}
