...
public class ModBlockEntities {
        ...
        public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<FurnaceBlockEntity>> FURNACE_ENTITY = BLOCK_ENTITIES
                        .register("furnace", () -> BlockEntityType.Builder
                                        .of(FurnaceBlockEntity::new, ModBlocks.FURNACE_BLOCK.get()).build(null));
