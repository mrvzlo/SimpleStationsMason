...
public class SifterRecipeCategory implements IRecipeCategory<SimpleRecipe> {
        private static final String Path = "sifter";
        ...
        public SifterRecipeCategory(IGuiHelper guiHelper) {
        ...
        public Component getTitle() {
                return Component.translatable("screen.simplestationsmason.sifter_recipes");
        }

        @Override
        public @Nullable IDrawable getIcon() {
                return guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK,
                                new ItemStack(ModBlocks.SIFTER_BLOCK_ITEM.get()));
        }
        ...
        public void setRecipe(IRecipeLayoutBuilder builder, SimpleRecipe recipe, IFocusGroup focuses) {
                ...
                builder.addSlot(RecipeIngredientRole.OUTPUT, UIBlocks.OUT_SLOT.left, UIBlocks.OUT_SLOT.top)
                                ...
                                .addRichTooltipCallback((v, t) -> t.add(Component.literal(recipe.chance + "%")));
